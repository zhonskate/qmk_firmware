...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT_reviung39(
    ...
    _______,  _______,  _______,  _______,  KC_MUTE,   KC_VOLD,            KC_PGDN,  KC_HOME,  KC_DOWN,  KC_END,   _______,  _______,
                                                       _______,  KC_TAB,   _______
  ),

  [_ADJUST] = LAYOUT_reviung39(
    _______,  KC_F1,    KC_F2,    KC_F3,    KC_F4,     KC_F5,              KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   _______,
    _______,  RGB_TOG,  RGB_HUI,  RGB_VAI,  RGB_MOD,   AU_TOG,             _______,  _______,  _______,  KC_F11,   KC_F12,   _______,
    _______,  _______,  RGB_HUD,  RGB_VAD,  RGB_RMOD,  CK_TOGG,            RESET,    _______,  _______,  _______,  _______,  _______,
