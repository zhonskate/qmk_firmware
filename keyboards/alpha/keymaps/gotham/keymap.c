...
#define CTL_M MT(MOD_RCTL, KC_M)

#define ALT_X MT(MOD_LALT, KC_X)
#define ALT_N MT(MOD_RALT, KC_N)

#define GUI_C MT(MOD_LALT, KC_C)
#define GUI_B MT(MOD_RALT, KC_B)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[HOME] = LAYOUT(
		...
		SFT_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, SFT_ENT,
		CTL_Z, ALT_X, GUI_C, LT(MODS2,KC_V), LT(MODS, KC_SPC), LT(OTHER,KC_B), ALT_N, CTL_M),
	...
	[MODS2] = LAYOUT(
		...
		KC_LSFT, KC_ESC, RGB_TOG, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS, KC_GRV, _______,
