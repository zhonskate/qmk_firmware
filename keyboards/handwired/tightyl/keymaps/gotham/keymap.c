...
#define LAYOUT_tightyl_base( \
  ...
  LAYOUT_wrapper( \
      ...
      CTL_EQL,  K21,  K22,  K23,  K24,  K25,                        K26,  K27,  K28,  K29,  K2A,  RCTL_T(KC_MINS), \
          KC_UP, KC_DOWN,  KC_LGUI, SP_LOWR, TB_RAIS,       EN_LOWR,  BK_RAIS,  MS_DEL, KC_LEFT, KC_RIGHT \
    )
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLEMAK_DH] = LAYOUT_tightyl_base_wrapper(
    ...
    [_DVORAK] = LAYOUT_tightyl_base_wrapper(
    ...
    [_WORKMAN] = LAYOUT_tightyl_base_wrapper(
    ...
    [_NORMAN] = LAYOUT_tightyl_base_wrapper(
