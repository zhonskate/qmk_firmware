...
static int32_t thumbstick_read_x(void) { return thumbstick_read(ADC_CHANNEL11, STICK_MAX_X, STICK_MIN_X, STICK_CENTER_X, X_AXIS_DEADZONE); }

static int32_t thumbstick_read_y(void) { return thumbstick_read(ADC_CHANNEL12, STICK_MAX_Y, STICK_MIN_Y, STICK_CENTER_Y, Y_AXIS_DEADZONE); }
